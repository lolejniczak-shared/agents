...
resp = client.register_agent(
        ...
        display_name = "v2gdriveoauth",
        description = "Agent that answers questions about gdrive assets",
        tool_description = "Agent that answers questions about gdrive assets",
